...
abstract class AppLocalizations {
  ...
  /// Bottom-nav label for the media library tab
  ///
  /// In en, this message translates to:
  /// **'Library'**
  String get navLibrary;

  /// Bottom-nav label for the IPTV tab
  ///
  /// In en, this message translates to:
  /// **'Live TV'**
  String get navLiveTv;

  /// Bottom-nav label for the EPG tab
  ///
  /// In en, this message translates to:
  /// **'Guide'**
  String get navGuide;
  ...
  /// No description provided for @connectBackendHint.
  ///
  /// In en, this message translates to:
